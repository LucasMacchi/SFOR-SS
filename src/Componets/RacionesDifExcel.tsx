"use client"
import {ITicketEXCEL, IViewRacionesDif } from "@/utils/interfaces";
import Image from "next/image"
import * as XLSX from 'xlsx';


export default function TicketsExcel ({getDiferenciasRacionesExcel}:{getDiferenciasRacionesExcel: () => Promise<IViewRacionesDif[]>}) {

    const color = "#32CD32"

    const createExcel = async () => {
        const data = await getDiferenciasRacionesExcel()
        if(data.length > 0) {
