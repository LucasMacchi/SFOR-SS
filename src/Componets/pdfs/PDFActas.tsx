...
const PDFActas = ({remitos}:{remitos:IRemitoT[]}) => (
    <Document>
        {remitos.map((rts) => (
            ...
            <View style={stylePedido.view}>
                ...
                <Text style={stylePedido.subtitleActa}>
                    En la ciudad de <Text style={stylePedido.subtitleActaData}>{rts.localidad}</Text> (Localidad),
                    lugar <Text style={stylePedido.subtitleActaData}>{rts.completo} </Text>
                    ...
                    Servicios N° <Text style={stylePedido.subtitleActaData}>{parseRemitoString(rts.pv,rts.numero)}</Text> 
