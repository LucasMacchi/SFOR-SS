...
const pageContruct = (e: IUniqRemito, copia: boolean,desgloses: IDesgloseDisplay[],venc:string,cai:string,insumos:IInsumo[],especial:string) => (
        <Page size={'A4'} style={stylePedido.page}>
            ...
            <View style={stylePedido.viewdata}>
                ...
                <View >
                    <Text style={stylePedido.body}>Remito {parseRemitoString(e.pv,e.numero)}</Text>
            ...
            <View style={stylePedido.viewdata}>
                ...
                <View style={{...stylePedido.viewdata,flexDirection: "column"}}>
                    <Text style={{...stylePedido.body,fontWeight: 900}}>PLAN: 3a entrega {e.periodo}</Text>
